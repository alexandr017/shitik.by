...
<main class="container">
    ...
    <div class="content">
        ...
        <img width="810" height="1080" class="about-photo" src="/themes/v3/images/about/photo.jpg" alt="Шитик Александр Андреевич" loading="lazy">
        ...
        <p>Во временна колледжа успел попробовать Ассемблер, Visual Basic, Pascal, C, C++, C#, Delphi, JavaScript, PHP. Большую часть проектов писал на Delphi и параллельно активно изучал PHP.</p>
