...
<main class="container">
    ...
    <div class="content">
        ...
        <time datetime="2023-01-06" class="date-pub">6 января 2023</time>
        ...
        <div><img src="/images/blog/total-2022/auto.jpeg" alt="Новое авто"></div>
        ...
        <h2 id="a-2">Спорт</h2>
        <p>В этом году как и в прошлом у меня было 28 пробежек общей продолжительностью 341 км. Если брать суммарный километраж за 4.5 года, то я уже набегал 1310 км. Более детально о всех моих пробежал этого года можно почитать вотдельной статье. В ней же есть несколько интересных графиков.</p>
        ...
        <h2 id="a-5">Игры</h2>
        <p>Как я уже писал в итоговой статье прошлого года я по прежнему не играю в какие-либо игры. Если в прошлом году я играл в судоку на телефоне, то в этом я даже и это перестал делать. Однако так как в этом году я стал жить не один, то среди будних вечером, когда оставались дома хорошо заходили пазлы. Все, кроме двух самых больших как раз и собрали в текущем году.</p>
        <div><img src="/images/blog/total-2022/puzzles.jpg" alt="Пазлы 2022"></div>
