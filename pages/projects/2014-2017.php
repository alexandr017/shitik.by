...
<p>
    ...
    Так же Вы можете <a rel="noopener" href="#">посмотреть мой список проектов прикладного программирования.</a>
</p>
...
<p>Вам было когда-либо стыдно за свои ранние проекты, которые вы делали очень давно? Наверняка да!
    ...
    Тем не менее я не стал удалять настольгический список моих проектов за 2013-2017 года.
...
<p>После 2017 года я не стал публиковать и дополнять свой список по трем причинам.
    Во-первых данное "портфолио" сейчас уже не является визитной карточкой программистов при собеседовании на новую работу.
...
<p>Так же я хотел включить сюда список прикладных программ на Delphi и C++, среди которых можно было выделить например FTP-клиент, программу для записи дисков, аудио-плеер, несколько задач по работе с закладками и todo-листами,
    ...
    Пока что я не могу найти даже исходников этих программ, но если найду их и ысвободное время докину на эту страницу.</p>
